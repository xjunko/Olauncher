package rina.works.launcher.data
...
class Prefs(context: Context) {
    private val PREFS_FILENAME = "app.rinalauncher"

    private val BACKGROUND_DIM = "BACKGROUND_DIM"
    ...
    var backgroundDim: Float
        get() = prefs.getFloat(BACKGROUND_DIM, 0.0f)
        set(value) = prefs.edit().putFloat(BACKGROUND_DIM, value).apply()
