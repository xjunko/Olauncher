...
import rina.works.launcher.data.Constants.ONE_DAY_IN_MILLIS
import rina.works.launcher.data.Prefs
import rina.works.launcher.helper.SingleLiveEvent
import rina.works.launcher.helper.WallpaperWorker
import rina.works.launcher.helper.formattedTimeSpent
import rina.works.launcher.helper.getAppsList
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val backgroundDimEvent = MutableLiveData<Float>()
...
//    }
    ...
    fun setBackgroundDim(amount: Float) {
        backgroundDimEvent.postValue(amount)
    }
}